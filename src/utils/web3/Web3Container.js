...
export default class Web3Container extends React.Component {
  state = { web3: null, accounts: null, tracking: null, management: null, isadmin: false, open: false, message: "" };
  ...
  render() {
    const { web3, accounts, tracking, management, isadmin, open, message } = this.state
